...
<head>
    ...
    <!-- webcam -->
    <link href="<?= base_url() ?>assets/sb-admin/webcam/css/bootstrap.min.css" rel="stylesheet">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav small">
                        ...
                        <?php if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'petugas pendaftaran') {
                        ?>
